...
### 1.3 Data Deidentification Requirements

All information inputted into NoteMate must be deidentified. You must not include identifiable personal information such as full names, dates of birth, Medicare numbers, health identifiers, or other government identifiers in any content processed through the Service. This applies to all audio recordings, text inputs, and any other data transmitted for processing. This requirement is essential to maintain privacy and security, as well as to comply with relevant privacy regulations. When referring to clients/patients in your documentation, use initials, reference numbers, or other non-identifying descriptors.
...
We manage international processing through partner services and technical controls. Our partner services include AI (with Amazon Bedrock hosted in Australia, while some services like Deepgram operate from the US), database storage, authentication, and payment processing. Technical controls include encrypted transmission, immediate processing deletion, no persistent storage of clinical data, and template storage in Australian data centres. By using Amazon Bedrock's Australian hosting for our primary AI processing, we enhance data sovereignty and compliance with local regulations.
